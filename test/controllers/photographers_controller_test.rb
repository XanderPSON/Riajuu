...
class PhotographersControllerTest < ActionController::TestCase
  ...
  test "should create photographer" do
    assert_difference('Photographer.count') do
      post :create, photographer: { description: @photographer.description, extras: @photographer.extras, pricing: @photographer.pricing }
    end
  ...
  test "should update photographer" do
    patch :update, id: @photographer, photographer: { description: @photographer.description, extras: @photographer.extras, pricing: @photographer.pricing }
    assert_redirected_to photographer_path(assigns(:photographer))
  end
